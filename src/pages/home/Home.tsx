...
const Home = () => {
  ...
  const viewsData = dashboardData?.views?.data.map((view) => {
    return (
      <div className={classes["overview__followers-details"]}>
        <div className={classes["overview__name-school_container"]}>
          <div className={classes["overview__name-school_container--sub"]}>
  ...
  const CommentsData = dashboardData?.comments.data.map((comment) => {
    return (
          ...
          <div className={classes["overview__comments-course_code-cont"]}>
            ...
            <div className={classes["overview__comments-school_logo--cont"]}>
              <img
                ...
                src={comment.lecture.campusLogo}
        ...
        <main className={classes["main__pane"]}>
          ...
          <div className={classes["main__container"]}>
            ...
            <div className={classes["overview__container"]}>
              ...
              <div className={classes["sub__overview-container-sub"]}>
                <h3 className={classes["overview__header"]}>Total Views</h3>
                <p className={classes["overview__score"]}>
              ...
              <div className={classes["overview__video-section"]}>
                ...
                {dashboardData?.video ? (
                  <>
                    <div>
                      <img
                        src={dashboardData?.video?.thumbnail}
                        alt="Image-of-video"
                  ...
                  <>
                    <p className={classes["video__upload-metrics"]}>
              ...
              <div className={classes["overview__followers-container"]}>
                ...
                <Link to="/followers" className={classes["button__follower"]}>
                  View All
                </Link>
              </div>

...
setLoading(true)
axios.put(`${baseUrl}/api/v1/lectures`, newLecture, {
  headers:{
     ...
     {deleting&& <DeleteLecture onCancel={()=>setDeleting(false)}/>}
      <div className={classes["existing__user-title"]}>
        ...
        <div>
          ...
          <div className={classes["light_btn"]} onClick={()=>setdropping(true)}>
...
{dropping && <div className={classes["drop_mneus"]} ref={divRef}>
<div className={classes["drop_mneus_item"]} onClick={()=>{
...
<div className={classes["drop_mneus_item"]} onClick={()=>setDeleting(true)}>
<img src={deleteIcon}/>
...
{editing && <div className={classes["drop_mneus"]} >
<div className={modalClasses["details__container"]}>
              ...
              <div   className={classes["info_pane"]}>
                <InfoCard id={'downloadPrice'} onChange={handleValueChange} type='number' info={lectureSelected?.downloadPrice} inscription='Download Price'/>

                <InfoCard id={'price'} onChange={handleValueChange} type='number' info={lectureSelected?.price} inscription='Per View Price'/>

                <InfoCard id={'currency'} onChange={handleValueChange} type='text' info={lectureSelected?.currency} inscription='Currency'/>
                
              </div>
              <div   className={classes["buttons_pane"]}>
<button onClick={()=>setediting(false)}>Cancel</button>
<button disabled={loading}  onClick={()=>handleUpdateLecture(lectureSelected)}>{loading?'Loading, please wait':'Save'}</button>
              </div>
     ...
     {deleting&& <DeleteLecture onCancel={()=>setDeleting(false)}/>}
      <div className={classes["mobile_existing__user-title"]}>
        ...
        <div>
          ...
          <div className={classes["mobile_light_btn"]} onClick={()=>setdropping(true)}>
...
{dropping && <div className={classes["mobile_drop_mneus"]} ref={mobileDivRef}>
<div className={classes["mobile_drop_mneus_item"]} onClick={()=>{
  setLectureSelected(lecture)
  setediting(true)}}>
<img src={edit}/>
<span>Edit content</span>
...
<div className={classes["mobile_drop_mneus_item"]} onClick={()=>setDeleting(true)}>
<img src={deleteIcon}/>
<span >Delete forever</span>
</div>
</div>
...
{editing && <div className={classes["mobile_drop_mneus"]} >

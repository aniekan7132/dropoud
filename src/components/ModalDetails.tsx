...
const ModalDetails = ({ closeModal, file }: Props) => {
  ...
  const handleVideoUpload = (e: React.FormEvent) => {
    ...
    if (topic.topic && description.description && course.course) {
      ...
      axios
        ...
        .then(() => {
          window.location.href = "/upload-successful";
        })
        .catch(() => {
  ...
  // Function that takes care of copying text
              ...
              <div className={classes["details__container"]}>
                ...
                >
                  ...
                  <Input
                    ...
                    className={
                      titleError
                        ? `${classes["title__input"]} ${classes["title__div-error"]}`
                        : `${classes["title__input"]}`
                    }
                    value={topic.topic}
              ...
              <div className={classes["videobox__div"]}>
                ...
                <div className={classes["links__container"]}>
                  ...
                  <div className={classes["link__div"]}>
                    <p>
                      https://dropoud.net/video/{user.campus}
                      {lecture_id}
                    </p>
                    {isCopied ? (

    ...
    <>
      <nav className={classes["side__nav-bar"]}>
        ...
        <div className={classes["nav__links-container"]}>
          ...
          <NavLink to="/notification" className={activeLink}>
            <img
              className={classes["nav__links-img"]}
              src={notification}
              alt="Home-logo"
          ...
          <NavLink to="/followers" className={activeLink}>
            <img
              className={classes["nav__links-img"]}
              src={followers}
              alt="Wallet-logo"
      ...
      <div className={classes["mobile_side__nav-bar"]}>
        <div className={classes["mobile_nav__links-container"]}>
          ...
          <div className={classes["mobile_nav__links"]} onClick={handlePopup}>
            <img
              className={classes["mobile_nav__links-img"]}
              src={message}
              alt="Content-logo"
          ...
          {popUp && (
            <div className={classes["navbar-mobile-links"]}>
              <NavLink to="/inbox" className={activeLink}>
                <img
                  className={classes["nav__links-img"]}
                  src={message}
              ...
              <div className={classes["mobile__line"]}></div>
              <NavLink to="/settings" className={activeLink}>
                <img
                  className={classes["nav__links-img"]}
                  src={setting}
              ...
              <button className={classes["logout__button"]}>
                <img
                  className={classes["nav__links-img"]}
                  src={logout}
                  alt="Wallet-logo"

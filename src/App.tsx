...
import PasswordSuccessScreen from "./pages/newPassword/PasswordSuccesScreen.tsx";
import BankFailedScreen from "./components/BankFailedScreen.tsx";
import Followers from "./pages/followers/Followers.tsx";
import Comments from "./pages/comments/Comments.tsx";
    ...
    <>
      ...
      <Router>
        <Routes>
          ...
          <Route path="/signup-successful" element={<SuccessScreen />} />
          ...
          <Route path="/password-changed" element={<PasswordSuccessScreen/>} />
          ...
          />
          <Route
            path="/failed-to-add-bank"
            element={<BankFailedScreen />}
          />
        </Routes>
      </Router>
    </>
